...
class NotificationManager:
    ...
    def add(self, consumer: NoticeConsumer):
        ...
        for friend in consumer.user.accountmodel.get_friends():
            self.notify_user(friend.user, {'type': 'online',
                                           'user': AccountSerializer(consumer.user.accountmodel).data})
    ...
    def notify_new_friend(self, user: User, friend: AccountModel):
        ...
        self.notify_user(friend.user, {'type': status, 'user': AccountSerializer(user.accountmodel).data})
